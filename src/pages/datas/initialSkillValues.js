const initialSkillValues = {
  ...
  nativeLanguage: { initial: 20, current: 20 },
  ...
  psychology: { initial: 1, current: 1 },
  ...
  fighting1: { initial: 25, current: 25 },
